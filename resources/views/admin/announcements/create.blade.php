...
<div class="animate-fadeInUp max-w-2xl">
    <div class="flex items-center gap-4 mb-8">
        ...
        <h1 class="text-3xl font-black" style="color: var(--color-text-primary)">New Announcement</h1>
    </div>
    ...
    <div class="card">
        ...
        <form method="POST" action="{{ route('admin.announcements.store') }}" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" name="title" value="{{ old('title') }}" required class="form-input" placeholder="Announcement title">
            </div>
            ...
            <div>
                ...
                <textarea name="content" rows="6" required class="form-input" placeholder="Announcement message...">{{ old('content') }}</textarea>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
